...
client = (callback) ->
  dostylus(false, ->
    clientFileNames = ['Settings', 'DiceFace', 'EquationBuilder', 'Game', 'Network', 'TutorialNetwork', 'nowListener', 'Screen', 'Screen/LobbyScreen', 'Screen/JoinWaitScreen', 'Screen/GoalWaitScreen', 'Screen/GoalScreen', 'Screen/GameScreen', 'Screen/EndRoundScreen', 'Screen/TutorialLobbyScreen', 'Screen/TutorialGoalScreen', 'ScreenSystem', 'Tutorial','main']
