...
client = (callback) ->
  dostylus(false, ->
    clientFileNames = ['Settings', 'DiceFace', 'EquationBuilder', 'Game', 'Network', 'Screen', 'Screen/LobbyScreen', 'Screen/JoinWaitScreen', 'Screen/GoalWaitScreen', 'Screen/GoalScreen', 'Screen/GameScreen', 'Screen/EndRoundScreen', 'ScreenSystem', 'main']
